...
vector<T> subproduct_tree_askew(const vector<T>& vals, const vector<U>& mod_tree, int P) {
	int N = vals.size(); //N is number of leaves
...
template <typename T>
T compute_product_node(const vector<T>& vals, int k) { //typically used to get the value for the m tree
	int N = vals.size();
...
template <typename T, typename U>
T compute_product_node(const vector<T>& vals, const U& modulus, int k) { //typically used to get the value for the m tree
	int N = vals.size();
...
template <typename T, typename U>
T compute_product_node_askew(const vector<T>& vals, const U& modulus, int k) { //typically used to get the value for the A tree
...
template <typename T, typename U>
T _compute_remainder_tree_value(const vector<T>& A, const U& modulus, int k, const T& V) {
...
template <typename T, typename U>
T compute_remainder_tree_value(const vector<T>& A, const vector<U>& m, int k, const T& V) {
