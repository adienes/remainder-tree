...
std::vector<T> compute_remainder_tree_layer(const std::vector<T>&, const std::vector<U>&, long long, T&, U&, bool update_forest_vals = false);


template <typename T, typename U>
std::vector<T> remainder_tree_in_forest(const std::vector<T>&, const std::vector<U>&, long long, T&, U&, bool update_forest_vals = false);
 ...
 */
template <typename T, typename U>
std::vector<T> remainder_forest(const std::vector<T>&, const std::vector<U>&, long long, long long, T& V, U& Y);
...
template <typename T, typename U>
std::vector<T> remainder_forest(const std::vector<T>&, const std::vector<U>&, long long, long long, T V = T(1));
